...
var users = (new Table('users', 1000));
...
var items = (new Table('items', 5000));
...
var comments = (new Table('comments', 10000));
...
var buy_now = (new Table('buynow', 10000));
