...
INSERT INTO items VALUES (1, 'Boris Vian - L\'automne a Pekin', 'Original edition', 30.0, 1, 50.0, 100.0, 0, 0, NOW(), DATE_ADD(NOW(), INTERVAL 5 DAY), 2, 2);
INSERT INTO items VALUES (2, 'Porsche 911 Turbo', 'Not a FLOOD car ! ;-)', 50000.0, 1, 0, 0, 0, 0, NOW(), DATE_ADD(NOW(), INTERVAL 7 DAY), 1, 14);
INSERT INTO items VALUES (3, 'VAX/1', 'Like new!', 1.0, 1, 0, 10.0, 0, 0, NOW(), DATE_ADD(NOW(), INTERVAL 1 DAY), 3, 12);
